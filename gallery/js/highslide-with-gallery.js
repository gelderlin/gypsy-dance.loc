...
lang : {
	...
	fullExpandTitle : 'Настоящий размер (f)',
	...
	previousTitle : 'Назад (стрепка влево)',
	nextTitle : 'Вперед (стрелка вправо)',
	moveTitle : 'Перемещать',
	fullExpandText : '1:1',
	number: 'Рисунок %1 из %2',
	restoreTitle : 'Нажмите, чтобы закрыть рисунок или нажмите и тяните для перемещения. Левая и правая стрелка листают вперед и назад.'
},
// See http://highslide.com/ref for examples of settings  
graphicsDir : '/gallery/css/graphics/',
